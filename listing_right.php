				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 hidden-sm hidden-xs">
						<div class="jp_navi_right_btn_wrapper">
							<ul>
								<li><a href="inscription.php"><i class="fa fa-user"></i>&nbsp; INSCRIPTION</a>
								</li>
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="jp_job_post_right_btn_wrapper jp_job_post_grid_right_btn_wrapper">
                                                                <ul>
                                                                    ...
                                                                    <li><a href="listing_single.php">Voir plus</a></li>
                                                ...
                                                <div class="jp_job_post_main_wrapper jp_job_post_grid_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont jp_job_post_grid_right_cont">
                                                                <h4>HTML Developeur (1 - 2 ans d'espérience.)</h4>
                                                                <p>Map Com</p>
                                                                <ul>
                                                                   
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Cotonou, Cocotomey</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="jp_job_post_right_btn_wrapper jp_job_post_grid_right_btn_wrapper">
                                                                <ul>
                                                                    ...
                                                                    <li><a href="listing_single.php">Voire plus</a></li>
                                                                    <li><a href="#">Postuler</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="jp_job_post_main_wrapper jp_job_post_grid_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont jp_job_post_grid_right_cont">
                                                                <h4>Sécuriter informatique(4 ans d"expérience.)</h4>
                                                ...
                                                <div class="jp_job_post_main_wrapper jp_job_post_grid_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont jp_job_post_grid_right_cont">
                                                                <h4>Mécanique (4ans d'expérience .)</h4>
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="jp_job_post_right_btn_wrapper jp_job_post_grid_right_btn_wrapper">
                                                                <ul>
                                                                    <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
                                                                    <li><a href="listing_right.php">Voir Profil</a></li>
                                                                    <li><a href="#">Postuler</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="jp_job_post_main_wrapper jp_job_post_grid_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont jp_job_post_grid_right_cont">
                                                                <h4>Android Developpeur (1 - 3 ans d'expérience.)</h4>
                                                                <p>flutter</p>
                                                                <ul>
                                                                    
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp;  Cotonou, Sènandé</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="jp_job_post_main_wrapper jp_job_post_grid_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont jp_job_post_grid_right_cont">
                                                                <h4>Administrateur des Réseau Informatique(2 - 4 ans d'expérience)</h4>
                                                                <p>Technology Pvt</p>
                                                                <ul>
                                                                  
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Calavi, Aconville</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="jp_job_post_right_btn_wrapper jp_job_post_grid_right_btn_wrapper">
                                                                <ul>
                                                                    <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
                                                                    <li><a href="listing_single.php">Voire Profil</a></li>
                                                                    <li><a href="#">Postuler</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="jp_job_post_main_wrapper jp_job_post_grid_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont jp_job_post_grid_right_cont">
                                                                <h4>Electricien(1 - 2 ans d'expérience)</h4>
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="jp_job_post_right_btn_wrapper jp_job_post_grid_right_btn_wrapper">
                                                                <ul>
                                                                    <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
                                                                    <li><a href="listing_single.php">Voir Profile</a></li>
                                                                    <li><a href="#">Postuler</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="jp_job_post_main_wrapper jp_job_post_grid_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont jp_job_post_grid_right_cont">
                                                                <h4>Comptable (1 - 2 ans d'experience)</h4>
                                                                <p>Webstrot Technology Pvt. Ltd.</p>
                                                                <ul>
                                                                    
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp;  Calavi, kpota</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="jp_job_post_main_wrapper jp_job_post_grid_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont jp_job_post_grid_right_cont">
                                                                <h4>Assistant de managment (1 - 3 ans d'expérience.)</h4>
                                                                <p>Webstrot Technology Pvt. Ltd.</p>
                                                                <ul>
                                                ...
                                                <div class="jp_job_post_main_wrapper jp_job_post_grid_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont jp_job_post_grid_right_cont">
                                                                <h4>Ressources humaine (1 - 2 ans d'expérience.)</h4>
                                                                <p>Webstrot Technology Pvt. Ltd.</p>
                                                                <ul>
                                                                  
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp;  Cotonou, Dédokpo</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont jp_job_post_grid_right_cont">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li><i class="fa fa-map-marker"></i>&nbsp; Porto , Novo</li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            <div class="jp_job_post_right_btn_wrapper jp_job_post_grid_right_btn_wrapper">
                                                                <ul>
                                                                    <li><a href="#"><i class="fa fa-heart-o"></i></a></li>
                                                                    <li><a href="listing_righr.php">Voir plus</a></li>
                                                                    <li><a href="#">Postuler</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="jp_job_post_main_wrapper jp_job_post_grid_main_wrapper">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="jp_job_post_right_cont jp_job_post_grid_right_cont">
                                                                <h4>HTML Developer (1 - 2 ans expérience)</h4>
                                                                <p>Webstrot Technology Pvt. Ltd.</p>
                                                                <ul>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="jp_footer_first_cont_wrapper">
                                <div class="jp_footer_first_cont">
                                    ...
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo quod voluptatem doloremque enim necessitatibus voluptates unde ipsa laudantium eligendi qui iusto quae, odio dolore! Voluptatum earum perferendis laboriosam excepturi qui!</p>
                                    <ul>
