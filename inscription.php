                        ...
                        <div class="header-area hidden-menu-bar stick" id="sticker">
                            ...
                            <div class="mainmenu">
                                <div class="gc_right_menu">
                                 ...
                                 <ul class="float_left">
                                    <li class="has-mega gc_main_navigation"><a href="index.html" class="gc_main_navigation">  Accueil&nbsp;<i class="fa fa-angle-down"></i></a>
                                        <!-- mega menu start -->
                                        <ul>
                                            
                                            <li class="parent"><a href="index_vi.html">Acceuil</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="parent gc_main_navigation"><a href="#" class="gc_main_navigation">candidats &nbsp;<i class="fa fa-angle-down"></i></a>
                                        <!-- sub menu start -->
                                        <ul>
                            ...
                            <div class="jp_register_section_main_wrapper">
                                <div class="jp_regis_left_side_box_wrapper">
                                    <div class="jp_regis_left_side_box">
                                        ...
                                        <ul>
                                            <li><a href="Employeur.html"><i class="fa fa-plus-circle"></i> &nbsp;JE SUIS RECRUTEUR</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="jp_regis_right_side_box_wrapper">
                                    ...
                                    <div class="jp_regis_right_side_box">
                                        ...
                                        <ul>
                                            <li><a href="candidat.html"><i class="fa fa-plus-circle"></i> &nbsp;INSCRIRE TOI CANDIDAT </a></li>
                                        </ul>
                                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="jp_footer_logo_wrapper">
                            <div class="jp_footer_logo">
                               <h1 style="color: #23c0e9;"> ISHEDE  </h1>
                            </div>
                        </div>
                    </div>
                    </div>
