...
<!-- Mirrored from www.webstrot.com/html/jobpro/job_light/index_vi.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Apr 2023 09:30:51 GMT -->
<head>
	<meta charset="utf-8" />
...
<body>
				...
				<div class="col-lg-6 col-md-6 col-sm-8 col-xs-12 hidden-xs">
					<div class="jp_top_header_left_wrapper">
						<div class="jp_top_header_left_cont">
							...
							<p class=""><i class="fa fa-envelope"></i> &nbsp;Email :&nbsp;<a href="#"><span class="__cf_email__" data-cfemail="9cd9f1fdf5f0dcf9e4fdf1ecf0f9b2fff3f1">[email&#160;protected]</span></a>
							</p>
						</div>
					</div>
				</div>
	...
	<div class="jp_top_header_img_wrapper" style="position: static;">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12 hidden-sm hidden-xs">
						<div class="jp_navi_right_btn_wrapper">
							<ul>
								<li><a href="register.html"><i class="fa fa-user"></i>&nbsp; SIGN UP</a>
								</li>
								<li><a href="login.html"><i class="fa fa-sign-in"></i>&nbsp; LOGIN</a>
								</li>
							</ul>
						</div>
					</div>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="ss_download_wrapper_details">
						...
						<p>Fast, Simple & Delightful. All it takes is 30 seconds to Download.</p> <a href="#" class="ss_appstore"><span><i class="fa fa-apple" aria-hidden="true"></i></span> App Store</a>
