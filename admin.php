...
if (isset($_POST["nom_a"])&& isset($_POST["prenom_a"])&& isset($_POST["adresse"])&& isset($_POST["email"])&& isset($_POST["password"])){
    $nom_a = $_POST["nom_a"];
 ...
 if(isset($_POST["btnAjouter"])){
    ...
    //c'est bon on peut ajouter
     $reqAexecuter = "INSERT INTO admin (nom_a, prenom_a, adresse, email, password) 
    VALUES ('$nom_a', '$prenom_a', '$adresse', '$email', '$password')";
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div role="tabpanel">
                            ...
                            <ul id="tabOne" class="nav register-tabs">
                                <li class="active"><a href="#contentOne-1" data-toggle="tab">Page admin <br>
                                       </a>
                                </li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active register_left_form" id="contentOne-1">
                                    ...
                                    <div class="row clearfix">
                                        <form action="admin.php" data-toggle="validator" method="POST">
                                            <!--Form Group-->
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                            <label> Nom  </label>
                                            <input type="text" name="nom_a" id="nom_a" placeholder="entrez le nom "
                                                    required>
                                            </div>
                                            ...
                                            <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                            <label>Prénom</label>
                                            <input type="text" name="prenom_a_E" id="prenom_a" placeholder="nom de l'entreprise"
                                                    required>
                                            </div>
